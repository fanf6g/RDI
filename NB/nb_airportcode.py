...
def airport_code(cv=CountVectorizer(dtype='int16'), alpha=1.0e-8):
    db = client['hotel']
    ...
    # [[ADDRESS, CITY, COUNTRY, CURRENCY, HOTEL, POSTAL_CODE, STATE, LBL]]
    ...
    y_train = pd_train.pop(LBL)
    y_valid = pd_valid.pop(LBL)
    y_test = pd_test.pop(LBL)
...
if __name__ == "__main__":
    ...
    print(airport_code(cv12, alpha=1e-8))
    print(str(cv12))
